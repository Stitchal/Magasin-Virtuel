<?php
session_start();
$GLOBALS["page"] = "adminFournisseur.php";
...
if (isset($_POST["suppr"])) {
  ...
  if (isset($_POST['boutonRechercher'])) {
    ...
    header('Location: adminFournisseur.php');
    exit();
  }
?>
    ...
    <form id="formRecherche" method="post">
      ...
      if (isset($_SESSION['recherche'])) {
        ...
        if (is_numeric($critere)) {
          ...
          $result = ConnexionDB::getInstance()->querySelect("SELECT * FROM fournisseur WHERE nom LIKE '%$critere%'");
        }
      } else {
      ...
      echo '<table class="bdd"><tbody>
            <tr><td>id</td><td>nomEntreprise</td><td>mail</td><td>mdp</td><td>infos</td>';
      ...
      echo '</tbody></table>';
      ?>
    <a href="adminFournisseurAjouter.php" title="Cliquez ici pour ajouter un fournisseur à la base de donnée">
      <div id="ajouter"><img src="img/ajouterArticle.png" alt="image ajouter article">
    </div>
    </a>
  </main>
</body>
