...
if (isset($_POST["submit"]) && isset($_POST["nom"]) && isset($_POST["prenom"]) && isset($_POST["mail"]) && isset($_POST["mdp"])) {
    ...
    header("Location: adminFournisseurAjouter.php?error=" . urlencode($error));
    exit();
}
...
<body>
    <main>
        ...
        <div class="client">
            ...
            <p><a class="retourPage" href="adminFournisseur.php" title="Cliquez ici pour retourner à la page des fournisseurs">←Retourner à la page des clients</a></p>
    </main>
    </a>
</body>
